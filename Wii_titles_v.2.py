...
url = 'https://en.wikipedia.org/wiki/List_of_Wii_games'
csv_file_path = 'Wii_games.csv'
        ...
        if len(columns) == 8:
            ...
            if 'Unreleased' not in na_status:
                ...
                #  THERE IS NO <a> element in TITLE
                    ...
                    platform = 'Wii'     #actually needed for NES
                ...
                # DEVELOPER 👨‍💻
                span_element = columns[1].find('span')  #NEEDED FOR WII
                if span_element:
                    sup_span = columns[1].find('a', string='NA') 
                    if sup_span:
                        ...
                        if label:
                            ...
                            developer = (label.text.strip())
                    else:
                        sup_span = columns[1].find('abbr', string='WW')
                        if sup_span:
                            # Get the label (text) associated with the <a> element
                            label = sup_span.find_parent('span').find_next_sibling(string=True).strip()
                            if label:
                    ...
                    if developer_elements:
                        ...
                        # developer = columns[1].get_text(strip=True) #false to leave spaces between commas.. ⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛⚠️🐛
                        # developer = columns[1].get_text(strip=True).replace(',', ', ')  #You Don't Know Jack WII
                        developer = ', '.join([part.strip() for part in columns[1].get_text().split(',')]) #You Don't Know Jack WII; this got rid of the extra spaces between commas Yamaha Supercross (developer: Aurona Games, Coyote Console)
