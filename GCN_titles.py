...
if response.status_code == 200:
    ...
    for row in rows:
        ...
        if len(columns) == 7:
            na_status = columns[6].get_text(strip=True)  # 'North America' column (index 5)
            ...
            if 'Unreleased' not in na_status:
                ...
                #  THERE IS NO <a> element in TITLE
                    ...
                    platform = 'GameCube'     #actually needed for NES
                ...
                # YEAR 📆
                first_released = columns[6].get_text(strip=True)  # "First Released" column (index 3)
